...
export function QueueWaiting({ position, totalInQueue, onPreviewMenu }: QueueWaitingProps) {
  return (
    <div className="flex flex-col items-center justify-center h-screen w-full bg-void text-bone p-6 scanline-overlay">
      <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8">
        ...
        <div className="flex items-center space-x-2 text-smoke bg-abyss px-6 py-3 rounded-full border border-eerie">
          ...
          <span className="font-mono">{position - 1} of {totalInQueue} customers ahead</span>
        </div>
      </div>
